    ...
    <label class="custom_check" v-show="show_addit">
      ...
      >
        ...
        <g clip-path="url(#clip1_318_2329)">
          ...
          />
          <path
            d="M43.1219 4.09155H40.4395V24.9324H59.5246"
            stroke=""
            stroke-miterlimit="10"
            stroke-linecap="round"
            stroke-linejoin="round"
          />
          <path
            d="M62.6002 4.09155H69.5606V24.9324H58.8972"
            stroke=""
            stroke-miterlimit="10"
            stroke-linecap="round"
            stroke-linejoin="round"
          ...
          />
          <path
            d="M56.8201 24.9326H53.1799V27.7406H56.8201V24.9326Z"
            stroke=""
            stroke-miterlimit="10"
            stroke-linecap="round"
            stroke-linejoin="round"
          />
          <path
            d="M60.4601 27.7404H49.5398V29.5605H60.4601V27.7404Z"
            stroke=""
            stroke-miterlimit="10"
            stroke-linecap="round"
            stroke-linejoin="round"
  ...
  computed: {
    sum() {
      if (this.sm > 0 || this.lg > 0) {
        if (this.addit) {
          let res =
            this.sm * (this.price_sm + 100) + this.lg * (this.price_lg + 1000);
  ...
  methods: {
    ...
    makeOrder() {
      ...
      const mainButtonHandler = function () {
        ...
        axios
          .post("https://wsbot.webnauts.space/web-data", data, {
